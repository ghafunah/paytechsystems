...
import com.paytech.paytechsystems.adapter.BranchCollectionAdapter;
...
public class BranchCollections extends AppCompatActivity  implements BranchCollectionAdapter.BranchCollectionAdapterListener, ActionBar.OnNavigationListener, SwipeRefreshLayout.OnRefreshListener{
        private static final String TAG = BranchCollections.class.getSimpleName();
    ///private List<User> usersList = new ArrayList<>();
    private SwipeRefreshLayout swipeRefreshLayout;
    private RecyclerView recyclerView;
    private BranchCollectionAdapter mAdapter;
    private List<BranchCollection> list;// = new ArrayList<>();;
...
//private static final String URL = "https://api.androidhive.info/json/contacts.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        mAdapter = new BranchCollectionAdapter(this, list, this);
...
//               Snackbar.make(view, R.string.no_internet, Snackbar.LENGTH_SHORT).setAction("Action", null).show();
//               //Intent login = new Intent(getApplicationContext(), NewBranchCollection.class);
//               //startActivity(login);
//               //finish();
//          }
//       });
   ...
   /**
    ...
    private void fetchUsers() {
        ...
        swipeRefreshLayout.setRefreshing(true);
        final JsonArrayRequest request = new JsonArrayRequest(Config.URL +"collection_branch.php?offset=300",
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                Integer id =  0;//j.getInt("lessonid");
                                String branch = j.getString("branch_name");
                                String fees = j.getString("Fees");
                                //String date = j.getString("date");
                                db.saveBranchCollection(id, branch, fees,  null);
                                Log.e(TAG, "Added to local DB: " + branch );
                        ...
                        List<BranchCollection> items = new Gson().fromJson(response.toString(), new TypeToken<List<BranchCollection>>(){}.getType());
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                //db.saveBranchCollection(page1, users1,1);
                list.clear();
                list.addAll(db.getAllBranchCollection());
                mAdapter.notifyDataSetChanged();

                Log.e(TAG, "BranchCollections Error: " + error.getMessage());
    ...
    @Override
    public void onBranchCollectionSelected(BranchCollection i) {
        Toast.makeText(getApplicationContext(), "Selected: " + i.getBranch(), Toast.LENGTH_SHORT).show();
    }
