...
import com.paytech.paytechsystems.adapter.PermissionAdapter;
...
public class Permissions extends AppCompatActivity  implements PermissionAdapter.PermissionAdapterListener, ActionBar.OnNavigationListener, SwipeRefreshLayout.OnRefreshListener{
...
//private static final String URL = "https://api.androidhive.info/json/contacts.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        mAdapter = new PermissionAdapter(this, list, this);
       ...
       fab.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View view) {
               ...
               Intent login = new Intent(getApplicationContext(), NewPermission.class);
               startActivity(login);
               //finish();
           }
       });
   ...
   /**
    ...
    private void fetchUsers() {
        ...
        swipeRefreshLayout.setRefreshing(true);
        final JsonArrayRequest request = new JsonArrayRequest(Config.URL +"permissions.php?offset=100",
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                String users = j.getString("users");

                                db.savePermission(page, users,1);
                        ...
                        List<Permission> items = new Gson().fromJson(response.toString(), new TypeToken<List<Permission>>(){}.getType());
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                //db.savePermission(page1, users1,1);
                list.clear();
                list.addAll(db.getAllPermissions());
                mAdapter.notifyDataSetChanged();

                Log.e(TAG, "Permissions Error: " + error.getMessage());
    ...
    @Override
    public void onPermissionSelected(Permission i) {
        Toast.makeText(getApplicationContext(), "Selected: " + i.getPage(), Toast.LENGTH_SHORT).show();
    }
