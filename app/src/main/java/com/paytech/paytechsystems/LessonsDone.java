...
import com.paytech.paytechsystems.adapter.LessonDoneAdapter;
...
public class LessonsDone extends AppCompatActivity  implements LessonDoneAdapter.LessonDoneAdapterListener, ActionBar.OnNavigationListener, SwipeRefreshLayout.OnRefreshListener{
        private static final String TAG = LessonsDone.class.getSimpleName();
    ///private List<User> usersList = new ArrayList<>();
    private SwipeRefreshLayout swipeRefreshLayout;
    private RecyclerView recyclerView;
    private LessonDoneAdapter mAdapter;
    private List<LessonDone> list;// = new ArrayList<>();;
...
//private static final String URL = "https://api.androidhive.info/json/contacts.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        mAdapter = new LessonDoneAdapter(this, list, this);
...
//               Snackbar.make(view, R.string.greetings, Snackbar.LENGTH_SHORT).setAction("Action", null).show();
//               //Intent login = new Intent(getApplicationContext(), NewLessonDone.class);
//               //startActivity(login);
//               //finish();
//           }
//       });
   ...
   /**
    ...
    private void fetchUsers() {
        ...
        swipeRefreshLayout.setRefreshing(true);
        final JsonArrayRequest request = new JsonArrayRequest(Config.URL +"lesson_done.php?offset="+Config.LIMIT,
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                String branch = "Branch";//j.getString("branch");
                                String date = j.getString("date");
                                db.saveLessondone(id, admno, student, lesson, course, teacher, vehicle, branch, date);
                                Log.e(TAG, "Added lesson to local DB: " + lesson );
                        ...
                        List<LessonDone> items = new Gson().fromJson(response.toString(), new TypeToken<List<LessonDone>>(){}.getType());
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                //db.saveLessonDone(page1, users1,1);
                list.clear();
                list.addAll(db.getAllLessonsdone());
                mAdapter.notifyDataSetChanged();

                Log.e(TAG, "LessonDones Error: " + error.getMessage());
    ...
    @Override
    public void onLessonDoneSelected(LessonDone i) {
