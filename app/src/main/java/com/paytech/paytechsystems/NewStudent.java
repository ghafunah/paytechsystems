...
public class NewStudent extends AppCompatActivity  {//implements View.OnClickListener
        private static final String TAG1 = NewStudent.class.getSimpleName();
        private Button btnsave;
        private EditText idno, fname, sname, email, yob, gender, phone;
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            branch2 = (AutoCompleteTextView) findViewById(R.id.branch);
            ...
            btnsave.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    ...
                    String yob1 = yob.getText().toString().trim();
                    ...
                    if (!sname1.isEmpty() && !fname1.isEmpty() && !phone1.isEmpty()) {
                        ...
                        saveStudent(idno1, fname1, sname1, yob1,branch1, email1, gender1, phone1, admno1);
                    } else {
...
//        site.setAdapter(new ArrayAdapter<String>(Register.this, android.R.layout.simple_list_item_1, site));
         ...
         * */
        private void saveStudent(final  String idno1, final String fname1, final String sname1,  final String yob1, final String branch1, final String email1, final String gender1, final String phone1, final String admno1){
            ...
            StringRequest strReq = new StringRequest(Request.Method.POST,  Config.URL + "student.php", new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        if (!error) {
                            ...
                            String yob = user.getString("yob");
                            String phone = user.getString("phone");
                            String branch = user.getString("branch");
                            String admno = user.getString("admno");
                            String admdate = user.getString("admdate");
                            //Integer status = 0;//user.getInt("status");

                            //String created_at = user.getString("created_at");

                            // Inserting row in users table
                            db.saveStudent(idno, fname, sname, yob, email, branch, gender, phone, admno, admdate, SYNCED_WITH_SERVER);

                            Toast.makeText(getApplicationContext(), "User successfully registered. Try login now!", Toast.LENGTH_LONG).show();

                            // Launch login activity
                            Intent intent = new Intent( NewStudent.this, Students.class);
                            ...
                            // message
                            db.saveStudent(idno1, fname1, sname1, yob1, email1, branch1, gender1, phone1, admno1, null, NOT_SYNCED_WITH_SERVER);
        ...
        public void cancel(View view) {
            ...
            Intent add_intent = new Intent(NewStudent.this, MainActivity.class)
