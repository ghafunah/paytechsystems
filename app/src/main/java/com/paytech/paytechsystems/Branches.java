...
public class Branches extends AppCompatActivity  implements BranchAdapter.BranchAdapterListener, ActionBar.OnNavigationListener, SwipeRefreshLayout.OnRefreshListener{
...
//private static final String URL = "https://api.androidhive.info/json/contacts.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        mAdapter = new BranchAdapter(this, list, this);
       ...
       fab.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View view) {
               ...
               //Intent login = new Intent(getApplicationContext(), NewBranch.class);
               //startActivity(login);
               //finish();
               newBranch();
           }
   ...
   /**
    ...
    private void fetchUsers() {
        ...
        swipeRefreshLayout.setRefreshing(true);
        final JsonArrayRequest request = new JsonArrayRequest(Config.URL +"branches.php?offset=100",
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                String till = j.getString("till");
                                String email = j.getString("email");
                                db.saveBranch(code, name, location, till, email, 1);
                                Log.e(TAG, "Added to local DB: " + code );
                        ...
                        List<Branch> items = new Gson().fromJson(response.toString(), new TypeToken<List<Branch>>(){}.getType());
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                //db.saveBranch(page1, users1,1);
                list.clear();
                list.addAll(db.getAllBranches());
                mAdapter.notifyDataSetChanged();

                Log.e(TAG, "Branches Error: " + error.getMessage());
    ...
    @Override
    public void onBranchSelected(Branch i) {
        Toast.makeText(getApplicationContext(), "Selected: " + i.getName(), Toast.LENGTH_SHORT).show();
    }
public  boolean CheckNet(Context context) {
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (scrollRange + verticalOffset == 0) {
                    collapsingToolbar.setTitle(getString(R.string.branches));
                    isShow = true;
                } else if (isShow) {
                    collapsingToolbar.setTitle(" ");
                    isShow = false;
    ...
    private void newBranch() {
        ...
        View view = layoutInflaterAndroid.inflate(R.layout.new_branch, null);

        AlertDialog.Builder alertDialogBuilderUserInput = new AlertDialog.Builder(Branches.this);
        alertDialogBuilderUserInput.setView(view);

        final EditText code = view.findViewById(R.id.code);
        final TextView name = view.findViewById(R.id.name);
        final EditText location = view.findViewById(R.id.location);
        final EditText till = view.findViewById(R.id.phone);
        ...
        alertDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(code.getText().toString()) || TextUtils.isEmpty(name.getText().toString())) {
                    Toast.makeText(Branches.this, "Branch code and name cannot be empty!", Toast.LENGTH_SHORT).show();
                    return;
                } else {
                    alertDialog.dismiss();
                }
                //Double am = admno.getText();
                db.saveBranch(code.getText().toString(), name.getText().toString(), location.getText().toString(), till.getText().toString(), email.getText().toString(), 0);
