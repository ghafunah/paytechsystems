...
import com.paytech.paytechsystems.adapter.TeacherAdapter;
...
public class Teachers extends AppCompatActivity  implements TeacherAdapter.TeacherAdapterListener, ActionBar.OnNavigationListener, SwipeRefreshLayout.OnRefreshListener{
        private static final String TAG = Teachers.class.getSimpleName();
	///private List<User> usersList = new ArrayList<>();
    private SwipeRefreshLayout swipeRefreshLayout;
    private RecyclerView recyclerView;
    private TeacherAdapter mAdapter;
    private List<Teacher> stdList;// = new ArrayList<>();;
...
//private static final String URL = "https://api.androidhive.info/json/contacts.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new TeacherAdapter(this, stdList, this);
   ...
   /**
    ...
    private void fetchUsers() {
        ...
        swipeRefreshLayout.setRefreshing(true);
        final JsonArrayRequest request = new JsonArrayRequest(Config.URL +"instructors.php?offset=200",
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                String mname = j.getString("mname");
                                String fname = j.getString("fname");
                                String sname = j.getString("sname");
                                String phone = j.getString("phone");
                                String email = j.getString("email");
                                String terms = j.getString("terms");
                                String special = j.getString("special");
                                db.saveTeacher(idno, fname, sname, mname, phone,email,terms,special, 1);
                        ...
                        List<Teacher> items = new Gson().fromJson(response.toString(), new TypeToken<List<Teacher>>(){}.getType());
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                stdList.clear();
                stdList.addAll(db.getAllTeachers());
                mAdapter.notifyDataSetChanged();
    ...
    @Override
    public void onTeacherSelected(Teacher i) {
        Toast.makeText(getApplicationContext(), "Selected: " + i.getFname() + ", " + i.getSname(), Toast.LENGTH_SHORT).show();
    }
