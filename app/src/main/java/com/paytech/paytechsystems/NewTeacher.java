...
public class NewTeacher extends AppCompatActivity  {//implements View.OnClickListener
    private static final String TAG1 = NewTeacher.class.getSimpleName();
...
//        site.setAdapter(new ArrayAdapter<String>(Register.this, android.R.layout.simple_list_item_1, site));
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        Intent intent = new Intent( NewTeacher.this, Login.class);
                        startActivity(intent);
                        finish();
                    } else {
    ...
    public void cancel(View view) {
        ...
        Intent add_intent = new Intent(NewTeacher.this, Teachers.class)
