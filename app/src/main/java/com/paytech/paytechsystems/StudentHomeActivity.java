...
public class StudentHomeActivity extends AppCompatActivity  implements StudentHomeAdapter.StudentHomeAdapterListener, ActionBar.OnNavigationListener, SwipeRefreshLayout.OnRefreshListener{
    ...
    private List<StudentHome> list;// = new ArrayList<>();;
...
//private static final String URL = "https://api.androidhive.info/json/contacts.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        mAdapter = new StudentHomeAdapter(this, list, this);
...
//        });
   ...
   /**
    ...
    private void fetchUsers() {
        ...
        swipeRefreshLayout.setRefreshing(true);
        final JsonArrayRequest request = new JsonArrayRequest(Config.URL +"student_home.php?offset="+per_page,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        list.clear();
                        list.addAll(db.getAllStudentHome(per_page));
                        //list.addAll(items);
    ...
    @Override
    public void onStudentHomeSelected(StudentHome i) {
        Toast.makeText(getApplicationContext(), "Selected: " + i.getAdmno() + ", " + i.getStudent()+ ", " + i.getPhone(), Toast.LENGTH_SHORT).show();
    }
