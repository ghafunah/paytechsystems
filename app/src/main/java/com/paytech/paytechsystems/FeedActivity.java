...
import com.paytech.paytechsystems.adapter.FeedListAdapter;
import com.paytech.paytechsystems.helper.Controller;
import com.paytech.paytechsystems.getset.FeedItem;
...
public class FeedActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (entry != null) {
            ...
            Controller.getInstance().addToRequestQueue(jsonReq);
        }
