...
public class NewLesson extends AppCompatActivity  {//implements View.OnClickListener
        private static final String TAG1 = NewLesson.class.getSimpleName();
            ...
            btnsave.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    ...
                    if (!sname1.isEmpty() && !fname1.isEmpty() && !password1.isEmpty()) {
                        ...
                        registerUser(idno1, fname1, sname1, uname1,branch1, email1, password1, phone1);
                    } else {
...
//        site.setAdapter(new ArrayAdapter<String>(Register.this, android.R.layout.simple_list_item_1, site));
         ...
         * */
        private void registerUser(final  String idno1, final String fname1, final String sname1,  final String uname1, final String branch1, final String email1, final String password1, final String phone1){
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        if (!error) {
                            ...
                            Toast.makeText(getApplicationContext(), "Lesson successfully saved!", Toast.LENGTH_LONG).show();

                            // Launch login activity
                            Intent intent = new Intent( NewLesson.this, Login.class);
                            startActivity(intent);
                            finish();
                        } else {
                            ...
                            // message
                            //db.saveLesson(idno1, fname1, sname1, uname1, email1, branch1, password1, phone1, NOT_SYNCED_WITH_SERVER);
        ...
        public void cancel(View view) {
            ...
            Intent add_intent = new Intent(NewLesson.this, Courses.class)
