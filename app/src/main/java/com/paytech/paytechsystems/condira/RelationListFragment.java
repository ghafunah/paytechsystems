...
public abstract class RelationListFragment extends Fragment {
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.ffragment_all_posts, container, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mAdapter = new FirebaseRecyclerAdapter<Relation, RelationViewHolder>(options) {
            ...
            protected void onBindViewHolder(RelationViewHolder viewHolder, int position, final Relation model) {
                ...
                //final String postSex = postRef.child("sex");
                final String postKey = postRef.getKey();
        // recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new RecyclerTouchListener.ClickListener() {
                //String fm = mDatabase.child("/Member/").child(postKey).getClass(Relation.class);
                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        // Launch PostDetailActivity
                        Timber.d("Test TTTTTTTTTTTTTTTTTTTTTTTT "+ postRef.getKey());
                        Intent intent = new Intent(getActivity(), NewRelationActivity.class);
