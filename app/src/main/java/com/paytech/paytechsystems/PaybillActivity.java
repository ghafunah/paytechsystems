...
import com.paytech.paytechsystems.adapter.PaybillAdapter;
...
public class PaybillActivity extends AppCompatActivity  implements PaybillAdapter.PaybillAdapterListener, ActionBar.OnNavigationListener, SwipeRefreshLayout.OnRefreshListener{
...
//private static final String URL = "https://api.androidhive.info/json/contacts.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        mAdapter = new PaybillAdapter(this, list, this);
   ...
   /**
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                       ...
                       // Log.d(TAG, response.toString());
                        ...
                        List<Paybill> items = new Gson().fromJson(response.toString(), new TypeToken<List<Paybill>>(){}.getType());
    ...
    @Override
    public void onPaybillSelected(Paybill i) {
        Toast.makeText(getApplicationContext(), "Selected: " + i.getTransID() + ", " + i.getFirstName()+ ", " + i.getTransAmount(), Toast.LENGTH_SHORT).show();
    }
